...
my $level = -1;
my @types = map { 'gv_fetchmeth' . $_ . "_autoload" } '', qw( _sv _pvn );
...
ok !XS::APItest::gv_fetchmeth_autoload_type(\%::, "method\0not quite!", 2, $level, 0), "gv_fetchmeth_autoload_pvn() is nul-clean";
