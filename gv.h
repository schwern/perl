...
#  define GvNAMEWASUTF8_get(gv)	({ assert(GvNAME_HEK(gv)); HEK_WASUTF8(GvNAME_HEK(gv)); })
#else
...
#  define GvNAMEWASUTF8_get(gv)	HEK_WASUTF8(GvNAME_HEK(gv))
#endif

#define GvNAME(gv)	GvNAME_get(gv)
#define GvNAMELEN(gv)	GvNAMELEN_get(gv)
#define GvNAMEUTF8(gv)	GvNAMEUTF8_get(gv)
#define GvNAMEWASUTF8(gv)	GvNAMEWASUTF8_get(gv)
